...
#<<<<<<< HEAD
#../configure CXXFLAGS="-O2 -fPIC -fopenmp -m64 -fstack-protector-all" F77=gfortran CC=gcc CXX=g++   --with-blas-lib="${MKLIB} -lmkl_gf_lp64 -lmkl_core -lmkl_gnu_thread -lgomp" --with-lapack-lib="${MKLIB} -lmkl_lapack95_lp64" --with-pardiso="-L${PARDISOLIB} -lpardiso500-GNU481-X86-64 -lgfortran"
#=======
